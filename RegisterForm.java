        ...
        register.addActionListener((ActionEvent ae) -> 
                                {
                                    ...
                                    {
                                       JOptionPane.showMessageDialog(null,"Registration Unsuccessful - Passwords doesnn't Match");
                                        flag=0;
                                    }
                                    else if(!Pattern.matches("[a-zA-Z0-9]{8,100}",String.valueOf(passText.getPassword())))
                                    {
