...
class Admin extends JFrame implements ItemListener,ActionListener{
    ...
    JComboBox display_names,p2_display_names,bus_display;
    Vector<String> vector_name=new Vector<String>();
    String[] column_2ndtab={"Bus id","Boarding Point","Destination Point", "Amount"};
    
    String[] thirdpanel_tablecolumn={"User Name","Boarding Point","Destination Point", "Amount"};
    ...
    Admin(String current_user,int admin_or_not){
        ...
        user_travel_log.getColumnModel().getColumn(0).setPreferredWidth(80);
        user_travel_log.getColumnModel().getColumn(1).setPreferredWidth(100);
        user_travel_log.getColumnModel().getColumn(2).setPreferredWidth(100);
        user_travel_log.getColumnModel().getColumn(3).setPreferredWidth(60);
        ...
        bus_log_table.getColumnModel().getColumn(0).setPreferredWidth(80);
        bus_log_table.getColumnModel().getColumn(1).setPreferredWidth(100);
        bus_log_table.getColumnModel().getColumn(2).setPreferredWidth(100);
        bus_log_table.getColumnModel().getColumn(3).setPreferredWidth(60);
    ...
    public void itemStateChanged(ItemEvent e){
        ...
        if(e.getSource()==p2_display_names){
            if(p2_display_names.getSelectedItem().equals("--select--")){
                ...
                try{
                    ...
                    Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/bootcamp_project?zeroDateTimeBehavior=convertToNull", "root", "" );
                    String str="select * from travellog where Username='"+(String)p2_display_names.getSelectedItem()+"'";
                    PreparedStatement ps=con.prepareStatement(str);
                    ResultSet rs=ps.executeQuery();
                    while(rs.next()){
                        column_2ndtab[0]=rs.getString(2);
                        column_2ndtab[1]=rs.getString(3);
                        column_2ndtab[2]=rs.getString(4);
                        column_2ndtab[3]=rs.getString(5);
        ...
        if(e.getSource()==bus_display){
            if(bus_display.getSelectedItem().equals("--select--")){
                ...
                try{
                    ...
                    Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/bootcamp_project?zeroDateTimeBehavior=convertToNull", "root", "" );
                    String str3="select * from travellog where BusId='"+(String)bus_display.getSelectedItem()+"'";
                    PreparedStatement ps=con.prepareStatement(str3);
                    ResultSet r=ps.executeQuery();
                    while(r.next()){
                        thirdpanel_tablecolumn[0]=r.getString(1);
                        thirdpanel_tablecolumn[1]=r.getString(3);
                        thirdpanel_tablecolumn[2]=r.getString(4);
                        thirdpanel_tablecolumn[3]=r.getString(5);
    ...
    public void panel2_arrangements(){
        ...
        p2_user_name.setBounds(70,0,200,50);
        ...
        p2_display_names.setBounds(250,12,150,30); 
    ...
    public void panel3_arrangements(){
        ...
        bus_display.setBounds(250,12,150,30);
